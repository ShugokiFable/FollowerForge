...
/// (GUI switch, CLI --mo2-instance, FFORGE_PREFER_MO2=1, FFORGE_MO2_INSTANCE, or
/// LocalAppData\FollowerForge\prefer-mo2 marker from the wizard).
...
public sealed class EnvironmentDiscovery(ILogger log)
{
    ...
    /// <param name="preferMo2">When true, try MO2 before Vortex. Null = use <see cref="ManagerPreference"/>.</param>
        ...
        bool? preferMo2 = null)
    {
        ...
        // Explicit MO2 intent. Do NOT treat SKYRIM_MO2_INSTANCE as prefer-MO2 — that env var
        // is shared with houseCARL and often points at a Vortex shim, not the user's MO2.
        var wantMo2 = preferMo2
        ...
        throw new DirectoryNotFoundException(
            ...
            + "(the one with ModOrganizer.ini). Do not point FollowerForge at a houseCARL shim."
