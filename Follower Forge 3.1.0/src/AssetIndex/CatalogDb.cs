...
public sealed class CatalogDb : IDisposable
{
    ...
    /// <summary>
    /// The catalogue is a disposable cache. Older Follower Forge builds used a different
    ...
    private void InvalidateIncompatibleSchema()
    {
        ...
        reader.Close();
        _log.Warning(
            "Follower Forge catalogue schema {OldVersion} is obsolete; invalidating the disposable cache for schema {NewVersion}.",
