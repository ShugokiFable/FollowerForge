...
public sealed class FollowerBuilderTests : IDisposable
{
    ...
    {
        var result = new FollowerBuilder(Log).Build(Profile(), FakeEnv(), _workspace, placementWorldspace: null);
        ...
        foreach (var name in new[]
        {
            ...
            "rebuild-profile.json", "build-report.html", "credits.md",
        })
    ...
    public void Build_RefusesToWriteInsideProtectedRoots()
    {
        ...
        Assert.Throws<UnauthorizedAccessException>(() =>
            new FollowerBuilder(Log).Build(Profile(), env, badWorkspace, placementWorldspace: null));
    }
