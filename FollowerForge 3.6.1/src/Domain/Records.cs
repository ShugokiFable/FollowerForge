...
/// <summary>Record signatures FollowerForge indexes from the winning load order.</summary>
public enum IndexedRecordType
{
    ...
    TextureSet, FormList,
    /// <summary>Books and notes — lore items a follower can carry.</summary>
    Book,
    /// <summary>Miscellaneous items: trinkets, keepsakes, tools.</summary>
    MiscItem,
    /// <summary>Potions, poisons and food.</summary>
    Ingestible,
    /// <summary>Alchemy and cooking ingredients.</summary>
    Ingredient,
    /// <summary>Arrows and bolts. A bow without these is a stick.</summary>
    Ammo
}
