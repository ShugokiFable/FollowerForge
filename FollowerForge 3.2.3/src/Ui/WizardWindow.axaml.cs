...
public partial class WizardWindow : Window
{
    ...
    private void UpdateManagerSwitchButton()
    {
        ...
        // Always offer a flip so dual installs can leave Vortex-default without env vars.
    ...
    {
        if (!_ready) return;
        var wantMo2 = _env?.Manager != ModManagerKind.Mo2;
        ManagerPreference.SetPreferMo2(wantMo2);
        // Catalogue rebuilds automatically: IsFresh compares stored manager to the new one.
        _coverage = null;
        _library = null;
        LocationLibraryBuilder.Invalidate();
        SetStatus(wantMo2
